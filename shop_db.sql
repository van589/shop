...
-- ----------------------------
-- Table structure for tb_shop_admin_user
-- ----------------------------
DROP TABLE IF EXISTS `tb_shop_admin_user`;
CREATE TABLE `tb_shop_admin_user`  (
...
-- ----------------------------
-- Records of tb_shop_admin_user
-- ----------------------------

-- ----------------------------
-- Table structure for tb_shop_carousel
-- ----------------------------
DROP TABLE IF EXISTS `tb_shop_carousel`;
CREATE TABLE `tb_shop_carousel`  (
...
-- ----------------------------
-- Records of tb_shop_carousel
-- ----------------------------

-- ----------------------------
-- Table structure for tb_shop_goods_category
-- ----------------------------
DROP TABLE IF EXISTS `tb_shop_goods_category`;
CREATE TABLE `tb_shop_goods_category`  (
...
-- ----------------------------
-- Records of tb_shop_goods_category
-- ----------------------------

-- ----------------------------
-- Table structure for tb_shop_goods_info
-- ----------------------------
DROP TABLE IF EXISTS `tb_shop_goods_info`;
CREATE TABLE `tb_shop_goods_info`  (
...
-- ----------------------------
-- Records of tb_shop_goods_info
-- ----------------------------

-- ----------------------------
-- Table structure for tb_shop_index_config
-- ----------------------------
DROP TABLE IF EXISTS `tb_shop_index_config`;
CREATE TABLE `tb_shop_index_config`  (
...
-- ----------------------------
-- Records of tb_shop_index_config
-- ----------------------------
...
-- ----------------------------
-- Table structure for tb_shop_order_item
-- ----------------------------
...
-- ----------------------------
-- Records of tb_shop_order_item
-- ----------------------------

-- ----------------------------
-- Table structure for tb_shop_shopping_cart_item
-- ----------------------------
DROP TABLE IF EXISTS `tb_shop_shopping_cart_item`;
CREATE TABLE `tb_shop_shopping_cart_item`  (
...
-- ----------------------------
-- Records of tb_shop_shopping_cart_item
-- ----------------------------
